...
1. **Adhere to the established conventions**
    - All code, file names, exports, schemas, hooks, and helpers **must** follow the rules defined in the other `.claude/rules/*` documents (project structure, naming conventions, feature workflow, translation, etc.).
